...
class DiViNaTests {
    ...
    @Test
    fun goToPicture3() {
        addTestDivINa(getStr(R.string.turbomediaManifestDiViNaTestFile))
        goToTOC()
        onView(withText("Mountains - 03.png")).perform(ViewActions.click())
    ...
    fun goToFirstPicture() {
        addTestDivINa(getStr(R.string.turbomediaManifestDiViNaTestFile))
        goToTOC()
        onView(withText("Mountains - 01.png")).perform(ViewActions.click())
    }
    ...
    fun goToLastPicture() {
        addTestDivINa(getStr(R.string.turbomediaManifestDiViNaTestFile))
        goToTOC()
        scrollUntilFoundTextAndClickUiAutomator("Mountains - 31.png")
    }
    ...
    fun clickRightSideMiddlePub() {
        addTestDivINa(getStr(R.string.turbomediaManifestDiViNaTestFile))
        goToTOC()
        scrollUntilFoundTextAndClickUiAutomator("Mountains - 16.png")
